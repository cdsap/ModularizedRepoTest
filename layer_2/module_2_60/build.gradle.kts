...
dependencies {
    ...
    implementation(project(":layer_1:module_1_6"))
    implementation(project(":layer_1:module_1_2"))
    implementation(project(":layer_1:module_1_1"))
    implementation(project(":layer_1:module_1_3"))
    implementation(project(":layer_1:module_1_22"))
    implementation(project(":layer_1:module_1_5"))
    ...
    implementation(project(":layer_1:module_1_7"))
